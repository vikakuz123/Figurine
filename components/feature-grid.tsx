const features = [
  ...
  {
    title: "Готовность к обновлению",
    text: "Исходные Blender-файлы уже добавлены в проект, поэтому дальше можно подключить реальные рендеры и экспорт в нужные форматы."
  }
];
