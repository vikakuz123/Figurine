    ...
    <section className="mx-auto grid max-w-5xl gap-8 px-6 py-16 lg:grid-cols-[0.9fr_1.1fr]">
      <div className="rounded-[30px] border border-line bg-panel/60 p-8">
        ...
        <p className="mt-4 text-base leading-8 text-textMuted">
          Войдите в аккаунт, чтобы сохранить понравившиеся товары, перейти к корзине и
          управлять своими данными.
        </p>
        <p className="mt-8 text-sm text-textMuted">
          Быстрый вход: `demo@figuriverse.ru` / `demo1234`
        </p>
      </div>
      <div>
        <AuthForm mode="login" />
        <p className="mt-4 text-sm text-textMuted">
          Нет аккаунта? <Link href="/auth/register" className="text-accentSoft">Зарегистрироваться</Link>
        </p>
      </div>
    </section>
  );
